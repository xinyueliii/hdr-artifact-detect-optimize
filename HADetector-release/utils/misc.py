...
def setup_for_distributed(is_master):
    ...
    # global log file path for mirroring prints
    ...
    def print(*args, **kwargs):
        ...
        if is_master or force:
            ...
            message = '[{}] '.format(now) + sep.join(str(a) for a in args) + end
            # console output
            builtin_print(message, end='')
...
def set_log_file(path):
    """Configure a global log file to mirror all prints.

    Args:
        path (str): File path to append logs.
    """
    global _LOG_FILE_PATH
    _LOG_FILE_PATH = path
