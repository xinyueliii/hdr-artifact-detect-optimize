...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/root/autodl-tmp/CASIA2.0/', type=str,
                        help='dataset path, should be our json_dataset or mani_dataset format. Details are in readme.md')
    parser.add_argument('--test_data_path', default='/root/autodl-tmp/CASIA1.0/', type=str,
...
def main(args):
    if args.output_dir:
        ...
        misc.set_log_file(os.path.join(args.output_dir, "log.txt"))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        optimizer.zero_grad()
        # Check and save best model after every epoch
