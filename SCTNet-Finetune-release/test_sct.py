...
parser.add_argument("--dataset_dir", type=str, default='/root/autodl-tmp/ICCV23/',
...
parser.add_argument('--pretrained_model', type=str, default='/root/autodl-tmp/SCT_Tel_S_ckpt/best_checkpoint.pth')
parser.add_argument('--test_best', action='store_true', default=False)
parser.add_argument('--save_results', action='store_true', default=True)
parser.add_argument('--save_dir', type=str, default="/root/autodl-tmp/SCT_Tel_S_ckpt/imgs")
...
def main():
    ...
    for idx, img_dataset in enumerate(datasets):
        ...
        if args.save_results:
            ...
            folder_name = img_dataset.scene_name
            cv2.imwrite(os.path.join(args.save_dir, '{}_pred.png'.format(folder_name)), pred_img_mu)
            save_hdr(os.path.join(args.save_dir, '{}.hdr'.format(folder_name)), pred_hdr)
            print(os.path.join(args.save_dir, '{}.hdr'.format(folder_name)))
